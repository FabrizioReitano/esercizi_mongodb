...
#In this problem you will be analyzing a dataset of student grades. Please import grades_5-3.js into a
#database and collection of your choice.
...
db.grades.aggregate([
	...
	{$group:{_id:{class_id:'$class_id', student_id:'$student_id'}, student_class_average_score:{$avg:'$scores.score'}}},
	{$group:{_id:{class_id:'$_id.class_id'}, class_average_score:{$avg:'$student_class_average_score'}}},
	{$sort:{class_average_score:-1}}
])
